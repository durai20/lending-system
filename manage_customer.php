    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('handshake', 'Manage Students', 'Manage Existing Students');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            <input type="text" class="form-control" id="searchInput" placeholder="Search Students Id " oninput = "searchCustomer()  " autocomplete = "off">
          </div>
              ...
              <table class="table table-bordered table-striped table-hover">
                <thead>
                  <tr>
                    ...
                    <th style="width: 13%;">Students Name</th>
